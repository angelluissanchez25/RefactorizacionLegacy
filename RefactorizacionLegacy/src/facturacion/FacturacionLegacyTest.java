 ...
 * Adaptado automáticamente tras el renombrado semántico del método principal.
 */
public class FacturacionLegacyTest {
    ...
    public void testClienteVipConDescuentoExtra() {
        // tipoCliente = 1, esSocioVip = true -> 25% descuento. 100 - 25 = 75
    ...
    public void testClienteVipSinDescuentoExtra() {
        // tipoCliente = 1, esSocioVip = false -> 15% descuento. 100 - 15 = 85
    ...
    public void testClienteEstandar() {
        // tipoCliente = 2, esSocioVip = true o false -> 5% descuento. 100 - 5 = 95
